...
class DashboardModel extends CI_Model {
    ...
    public function totalsels($date = null) {
        ...
        $this->db->select_sum('sub_total_amount');
       ...
       // echo '<br>' . $this->db->last_query();
        if (count($result->sub_total_amount) > 0) {
            return $result->sub_total_amount;
        } else {
            return false;
        }
    }

    public function countValue($table = null, $column_name = null, $date = null) {
