            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="panel-body panel-filter">
                        <form role="form" id="filter-form" accept-charset="utf-8" method="get" action="<?php echo $action_url . '/customer/loyaltyHistory'; ?>">
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            echo $action_url . '/customer/loyaltyHistory';
                    ...
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">Loyalty History list</p>
