            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="panel-body panel-filter">
                        <form role="form" id="filter-form" accept-charset="utf-8" method="get" action="<?php echo $action_url . '/customer/loyalty'; ?>">
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo $action_url . '/customer/loyalty'; ?>" data-toggle="tooltip" title="Cancle"><i class="fa fa-times"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">Loyalty Point List</p>
                                ...
                                if (!empty($addlist)) {
                                    foreach ($addlist as $list) {
                                        ...
                                        ?> <tr>
                                            ...
                                            <td><?php echo $list->loyalty_point; ?></td>
                                    ...
                                    echo '<tr><th class="text-center" colspan="3"> No Records Available</th></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
