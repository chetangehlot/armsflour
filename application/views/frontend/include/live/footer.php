...
<div class="footerfkm">
    <div class="container">
        <div class="row">
            <div class="col-sm-8"> 
                <img class="imgftm" src="<?php echo base_url('assets/images/focmobile.png'); ?>" alt="" class="phone"> 
            </div>
            <div class="col-sm-2 col-md-2 col-xs-6 text-center trackbygtm" data-object-category="Button Footer Strip" data-object-label="Android" data-object-action="Open Playstore">
                <a href="https://play.google.com/store" target="_blank">
                    <img  src="<?php echo base_url('assets/images/googleplay.png'); ?>" alt="" class="img-responsive">
                </a>
            </div>
            <div class="col-sm-2 col-md-2 col-xs-6 text-center trackbygtm" data-object-category="Button Footer Strip" data-object-label="iOS" data-object-action="Open Appstore">
        ...
        <div class="w3_footer_grids">
            <div class="col-xs-12 col-md-4 col-sm-4 footer-grids w3-agileits">
                ...
                <ul class="f2">
                    ...
                    <li><a href="<?php echo base_url('deliveryPolicy') ?>">Delivery Policy</a></li>
            ...
            <div class="col-xs-12 col-md-4 col-sm-4 footer-grids w3-agileits">
                ...
                <ul class="f2">
                    ...
                    <li><a href="<?php echo base_url('download'); ?>">APK</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-md-4 col-sm-4 footer-grids w3-agileits">
                <h3>Follow</h3>
...
<?php } if ($this->router->fetch_class() == 'Home' && $this->router->fetch_method() == 'index') { ?>
    ...
    <script src="<?php echo base_url(); ?>assets/fnt/js/bootstrap3-typeahead.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/fnt/js/easyResponsiveTabs.js"></script>
    <script type="text/javascript">
    var kitcin = '<?php echo $this->session->userdata('
kitchen_address '); ?>';
    var locaid = '<?php echo $this->session->userdata('
location '); ?>';
    $(document).ready(function () {
