...
<!-- Mirrored from shoppestores.com/demos/herbs/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Oct 2018 03:21:41 GMT -->
<head>
	...
	<title>Herbs &amp; Spices Shoppe Stores - Bootstrap 3 Template</title>
				...
				<!-- Navbar Cat collapse Starts -->
					<div class="collapse navbar-collapse navbar-cat-collapse">
						<ul class="nav navbar-nav">
							<li><a href="category-list.html">Dried Spice</a></li>
							<li class="dropdown">
								<a href="category-list.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10">
									Spices & Herbs
								</a>
								<ul class="dropdown-menu" role="menu">
									<li><a tabindex="-1" href="#">Spice Blends</a></li>
									<li><a tabindex="-1" href="#">Organic</a></li>
									<li><a tabindex="-1" href="#">Flowers</a></li> 
								</ul>
							</li>
							<li class="dropdown">
								<a href="category-list.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10">Papricas </a>
								<div class="dropdown-menu">
									<div class="dropdown-inner">
										<ul class="list-unstyled">
											<li class="dropdown-header">Spices & Herbs</li>
											<li><a tabindex="-1" href="#">item 1</a></li>
											<li><a tabindex="-1" href="#">item 2</a></li>
											<li><a tabindex="-1" href="#">item 3</a></li>
										</ul>										
										<ul class="list-unstyled">
											<li class="dropdown-header">Spice Blends</li>
											<li><a tabindex="-1" href="#">item 1</a></li>
											<li><a tabindex="-1" href="#">item 2</a></li>
											<li><a tabindex="-1" href="#">item 3</a></li>
										</ul>
										<ul class="list-unstyled">
											<li class="dropdown-header">Organic</li>
											<li><a tabindex="-1" href="#">item 1</a></li>
											<li><a tabindex="-1" href="#">item 2</a></li>
											<li><a tabindex="-1" href="#">item 3</a></li>
										</ul>
							...
							<li><a href="category-list.html">Organic Spice Set </a></li>
							<li><a href="category-list.html">Sasonings</a></li>
							<li><a href="category-list.html">Marinades </a></li>
							<li><a href="category-list.html">Resins </a></li>
							<li><a href="category-list.html">Spice Blends </a></li>
							<li><a href="category-list.html">Roots & Rhizomes  </a></li>
							<li class="dropdown">
						<a href="category-list.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10">
							Pages
						</a>
...
<!-- Main Container Starts -->
	...
	<!-- 3 Column Banners Starts -->
		<div class="col3-banners">
			<ul class="row list-unstyled">
				<li class="col-sm-4"><img src="images/banners/3col-banner1.jpg" alt="banners" class="img-responsive" /></li>
				<li class="col-sm-4"><img src="images/banners/3col-banner2.jpg" alt="banners" class="img-responsive" /></li>
				<li class="col-sm-4"><img src="images/banners/3col-banner3.jpg" alt="banners" class="img-responsive" /></li>
			</ul>
		</div>
						...
						<div class="item">
							<div class="product-col">
								...
								<div class="caption">
									...
									<ul class="list-unstyled list-inline list-ratings">
	...
	<!-- 2 Column Banners Starts -->
		<div class="col2-banners">
			<ul class="row list-unstyled">
				<li class="col-sm-6"><img src="images/banners/2col-banner1.jpg" alt="banners" class="img-responsive" /></li>
				<li class="col-sm-6"><img src="images/banners/2col-banner2.jpg" alt="banners" class="img-responsive" /></li>
			</ul>
		</div>
...
<!-- Footer Section Starts -->
	...
	<!-- Copyright Area Starts -->
		...
		<!-- Container Starts -->
			...
			<!-- Starts -->
				<p class="pull-left">
					&copy; 2017 Herbs &amp; Spices Shoppe Stores. Designed By <a href="http://sainathchillapuram.com/">Sainath Chillapuram</a>
				</p>
			<!-- Ends -->
...
<!-- Mirrored from shoppestores.com/demos/herbs/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Oct 2018 03:24:05 GMT -->
</html>